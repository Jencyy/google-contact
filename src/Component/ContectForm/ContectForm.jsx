...
const ContactForm = () => {
  ...
  return (
        <div className="container contact-form mt-5 pt-5">
        ...
        <div className="col-md-6">
          <form onSubmit={handleSubmit}>
              ...
              <input type="file" className="form-control" id="avatar" aria-describedby="avatarHelp" onChange={handleImg} />
                            <div id="avatarHelp" className="form-text">Change the image for your avatar.</div>
            </div>
            <div className="mb-3">
            ...
            <div className="mb-3">
                            ...
                            <input type="tel" className="form-control" id="phoneNumber" name="phone" onChange={handleChange} value={contact.phone} />
            </div>
            <div className="mb-3">
